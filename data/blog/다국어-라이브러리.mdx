...
draft: false
summary: '다국어 라이브러리는 어떤 종류들이 있는지 확인을 해본다.
국제화, 지역화에 대한 구분도 참고 할 수 있도록 한다.
회사에서 왜 i18을 채택을 했는지 알아보자.'
---

# [1] TIL_다국어지원 라이브러리_240714

**목차**
1. i18next, react-intl, polyglot.js

---

# ✍학습 키워드
i18next, react-intl, polyglot.js
