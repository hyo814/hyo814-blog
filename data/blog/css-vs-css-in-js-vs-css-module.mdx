...
| **기술**             | **주로 활용하는 경우**                                                                                                                                    |
|----------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Styled Components** | - 동적 스타일링이 필요할 때
                         - 컴포넌트 단위로 스타일을 관리하고 싶을 때
                         - JavaScript의 기능을 스타일링에 활용하고 싶을 때
                         - 테마를 쉽게 적용하고 싶을 때 |
| **Emotion**           | - 성능 최적화가 중요할 때
- 동적 스타일링과 테마 적용이 필요할 때
- 작은 패키지 크기가 중요한 프로젝트일 때
- 유연한 스타일링 방법이 필요할 때        |
| **CSS**               | - 간단한 스타일링이 필요할 때
- 프로젝트가 작고 복잡하지 않을 때
- 기존의 전통적인 방식으로 스타일링을 관리하고 싶을 때                               |
| **CSS Module**        | - 클래스 이름 충돌을 방지하고 싶을 때
- 컴포넌트 단위로 스타일을 관리하고 싶을 때
- 정적 분석과 간단한 설정을 원할 때                                   |
