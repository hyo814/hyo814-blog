---
title: React Infinite Scroll 구현하기.mdx
date: '2024-09-27'
tags: [무한스크롤]
draft: false
summary: '무한스크롤'
...
# React Infinite Scroll 구현하기: useInfiniteQuery, useQuery, useSWR 비교
...
React에서 무한 스크롤을 구현하는 데는 여러 가지 방법이 있으며, 각각의 라이브러리와 Hook은 장단점이 있습니다. `useInfiniteQuery`는 기본적으로 페이지네이션 처리가 내장되어 있어 간편하게 무한 스크롤을 구축할 수 있습니다. 반면, `useQuery`나 `useSWR`을 사용하는 경우 무한 스크롤을 수동으로 처리해야 하며, 더 많은 코드 작성이 필요할 수 있습니다.
