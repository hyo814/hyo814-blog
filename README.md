...
개선은 수치로 확인합니다. 신청서 항목 모달의 후보 조회를 [20회에서 2회로](https://hyo814-blog.vercel.app/blog/신청서-항목-모달에서-후보-조회-20회를-2회로-줄였다), 표준데이터 카드 목록의 쿼리를 [39개에서 19개로](https://hyo814-blog.vercel.app/blog/같은-표준데이터를-두-화면이-198건과-134건으로-세고-있었다) 줄였고, 목업 시드를 [수작업 49개에서 엑셀 기반 478개 자동 생성](https://hyo814-blog.vercel.app/blog/목업-데이터-엑셀-시드-49에서-478개-자동화)으로 바꿨습니다. 이 블로그의 성과 수치에는 측정 과정을 남긴 개별 글이 근거로 달려 있습니다.
